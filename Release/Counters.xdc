...
#set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports BTN_0]
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports trig]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports echo]
...
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports stb]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports clk_kHz]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports dio]
...
#set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports trig]
...
connect_debug_port u_ila_0/probe0 [get_nets [list dio_OBUF]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list stb_OBUF]]
